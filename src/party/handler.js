...
const HANDLER_BUILD = "2026-03-10-party-board-split-final-v4";
...
async function handleParty(interaction) {
  ...
  // 아래 기존 버튼/모달 로직은 그대로 유지
  // (join / wait / waitoff / leave / edit / manage / start / end / delete)
